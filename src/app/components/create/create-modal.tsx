...
import { uploadFile,setDoc,authSubscribe,type User,listDocs } from "@junobuild/core";
...
export default function CreateModal() {
    ...
    const [time, setTime] = useState<BigInt>();
    ...
    async function checkUser() {
      ...
      try{
        ...
        console.log(myDoc)
        console.log(myDoc.items[0].key);
        setTime(myDoc.items[0].updated_at);
        setKey(myDoc.items[0].key);
      }
      catch(error){
        console.log(error);
      }
